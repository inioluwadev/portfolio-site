...
export const aboutContentSchema = z.object({
  ...
  substack_url: z.string().url({ message: "Must be a valid Substack URL." }).or(z.literal('')).optional().nullable(),
  rss_url: z.string().url({ message: "Must be a valid RSS Feed URL." }).or(z.literal('')).optional().nullable(),
});
