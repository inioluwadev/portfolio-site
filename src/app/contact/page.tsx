  ...
  return (
    <div className="container max-w-4xl mx-auto py-16 md:py-24 px-4">
      <div className="text-center mb-12 animate-fadeInUp">
        <h1 className="font-headline text-4xl md:text-5xl text-gradient">Get In Touch</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="animate-fadeInUp animation-delay-200 glass-card rounded-lg p-8">
